  ...
  handleFullScreenVideo(selectVideo, elem) {
    ...
    if (elem != null) {
      ...
      if (playPromise !== undefined) {
        ...
        // Unshift will return item beginning of history carousel. Push will return item end of carousel.
        if (exists === false) {
  ...
  render() {
    ...
    return (
      <div className="container center">
        <h2 align="left"> Recently Watched </h2>
        {videos && selectedVideo ? (
          <div>
            <div className="row">
              <VideoCarousel
                videos={this.historyVideos}
